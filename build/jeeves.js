...
(function() {
  var Jeeves, LONG_INTERVAL, LONG_TIMEOUT, SHORT_INTERVAL, SHORT_TIMEOUT, asserters, async, webdriver, winston, _, _elFuncSuffix, _elementFuncTypes,
  ...
  module.exports = Jeeves = (function() {
    ...
    function Jeeves(driver, options) {
      var _ref;
      this.driver = driver;
      if (options == null) {
        options = {};
      ...
      this._screenshotDir = (_ref = options.screenshotDir) != null ? _ref : "" + (process.cwd()) + "/test-results/screenshots";
    }
    ...
    Jeeves.prototype.stopBrowser = function(done) {
      ...
      return this.executeClientScript(clientScript, function(error) {
        if (error) {
          winston.error('Stopping browser failed', error);
        }
        return done();
      });
    };
      ...
      return this.stopBrowser((function(_this) {
        return function(error) {
          ...
          return _this.driver.get(url).nodeify(function(error) {
            winston.test("Tried to load " + url, error || 'no error');
            return done(error);
          });
        };
      })(this));
    ...
    Jeeves.prototype.loadPageAndWait = function(url, done) {
      ...
      return this.loadPage(url, (function(_this) {
        return function(error) {
          var _ref;
          if (error) {
            winston.error("Error loading page: " + ((_ref = error.message) != null ? _ref : error));
            return done(error);
          }
          return _this.waitForUrlToChange(url, true, function(error, actualUrl) {
            winston.test('@loadPageAndWait got', (error ? "Error: " + error.message : actualUrl));
    ...
    Jeeves.prototype.takeScreenshot = function(subdir, filename, done) {
      ...
      return this.driver.takeScreenshot().nodeify(function(error, imgBuffer) {
        ...
        fs = require('fs');
        directory = "" + this._screenshotDir + "/" + subdir;
    ...
    Jeeves.prototype.checkForElemWithProperText = function(elemCssPath, elemText, done) {
      ...
      return this.namedSteps({
        checkForElementByCss: (function(_this) {
          return function(next) {
            return _this.checkForElementByCss(elemCssPath, function(error, _exists) {
              elemExists = _exists;
              return next(error, elemExists);
            });
          };
        })(this),
        checkForTextByCss: (function(_this) {
          return function(next) {
            ...
            if (elemText != null) {
              return _this.isTextPresentByCss(elemCssPath, elemText, next);
            }
          };
        })(this)
        ...
        if (_result = (results != null ? results.checkForElementByCss : void 0) && (results != null ? results.checkForTextByCss : void 0)) {
    ...
    Jeeves.prototype.waitForUrlToChange = function() {
      ...
      return this.waitForSomething(checkUrl, {
        ...
        return function(error) {
          var _ref;
          winston.test('-- waitForUrlToChange done. Attempting to get url', [expectedUrl, (_ref = error != null ? error.message : void 0) != null ? _ref : 'no error']);
          if (error) {
            return done(error);
          }
        ...
        return function(error) {
          ...
          return _this.waitForSomething(function(callback) {
            return _this.getInnerHtmlByCss(selectorValue, function(error, html) {
              winston.test('    html is: ' + (html != null ? html : '[empty]'));
              if (error) {
                return callback(error);
              }
              htmlToReturn = html;
            ...
            winston.test("done waiting for regex to match " + (error != null ? error : 'no error'));
            if (error) {
              return done(error);
            }
    ...
    Jeeves.prototype.clickAndStamp = function(startElement, endpointPosition, endpointElement, done) {
      ...
      return this.driver.moveTo(startElement, void 0, void 0).buttonDown(0).buttonUp(0).moveTo(endpointElement, 205, -5).moveTo(endpointElement, endpointPosition.x, endpointPosition.y).buttonDown(0).buttonUp(0).nodeify(done);
    };
  ...
  _.each(_elementFuncTypes, function(type) {
    ...
    DriverWrapper.prototype['clearAndSendText' + _elFuncSuffix(type)] = function(selectorValue, text, done) {
      ...
      return this["getElement" + (_elFuncSuffix(type))](selectorValue, function(error, elem) {
        ...
        return elem.clear().then(function() {
          return winston.test("Element cleared! Attempting to type: " + text);
    ...
    DriverWrapper.prototype['doubleClickElement' + _elFuncSuffix(type)] = function() {
      ...
      winston.test("@clickElement" + (_elFuncSuffix(type)) + " using selectorValue: " + selectorValue);
      xOffset = (_ref = offsets.shift()) != null ? _ref : 0;
      yOffset = (_ref1 = offsets.shift()) != null ? _ref1 : 0;
    ...
    DriverWrapper.prototype['isChecked' + _elFuncSuffix(type)] = function(selectorValue, done) {
      ...
      return this["getElement" + (_elFuncSuffix(type))](selectorValue, (function(_this) {
        return function(error, elem) {
          ...
          return _this.getAttributeValue(elem, 'checked', function(error, checked) {
            winston.test("isChecked result: " + (!!checked));
            return done(error, !!checked);
          });
        };
      })(this));
    };
    ...
    DriverWrapper.prototype['getElemLocation' + _elFuncSuffix(type)] = function(selectorValue, done) {
      ...
      return this["getElement" + (_elFuncSuffix(type))](selectorValue, function(error, elem) {
        ...
        return elem.getElementLocation().nodeify(function(error, elemLoc) {
    ...
    DriverWrapper.prototype['waitForText' + _elFuncSuffix(type)] = function() {
      ...
      timeout = timeout != null ? timeout : SHORT_TIMEOUT;
      interval = interval != null ? interval : SHORT_INTERVAL;
      return this.driver["waitForElement" + (_elFuncSuffix(type))](selectorValue, asserters.nonEmptyText, timeout, interval).nodeify((function(_this) {
        return function(error) {
    ...
    DriverWrapper.prototype['waitForElementText' + _elFuncSuffix(type)] = function() {
      ...
      return this["waitForAndGetElement" + (_elFuncSuffix(type))](selectorValue, {
        ...
        return function(error, elem) {
          ...
          return elem.textPresent(text).nodeify(function(error, present) {
            winston.test("text present? => " + present);
            return done(error, present);
          });
        };
      })(this));
    };
