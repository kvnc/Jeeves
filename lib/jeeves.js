...
(function() {
  ...
  module.exports = Jeeves = (function() {
    ...
    Jeeves.prototype._utils = {
      enableWdLogs: function() {
        this.driver.on('status', function(info) {
          return logger.warn("wd_status << " + info);
        });
        return this.driver.on('command', function(method, callPath, data) {
          var _ref1;
          ...
          return logger.trace("wd_cmd >> " + method + " " + callPath + " with data: " + (data || 'NO_DATA'));
        });
      }
    };
    ...
    function Jeeves(driver, options) {
      var wd_config, _ref1, _ref2, _ref3;
      this.driver = driver;
      if (options == null) {
        options = {};
      }
      ...
      if (this.driver == null) {
        this.driver = webdriver.promiseChainRemote(wd_config);
      }
      if (options.wdLogging) {
        this._utils.enableWdLogs();
      }
      ...
      this._screenshotDir = (_ref3 = options.screenshotDir) != null ? _ref3 : "" + (process.cwd()) + "/test-results/screenshots";
    }
    ...
    Jeeves.prototype.clickAndStamp = function(startElement, endpointPosition, endpointElement, done) {
      ...
      return this.driver.moveTo(startElement, void 0, void 0).screenshot('clickAndStamp', "" + startElement + "-before-click").click(0).moveTo(endpointElement, 205, -5).moveTo(endpointElement, endpointPosition.x, endpointPosition.y).click(0).screenshot('clickAndStamp', "" + startElement + "-after-stamp").nodeify(done);
    };
