...
(function() {
  ...
  module.exports = Jeeves = (function() {
    ...
    Jeeves.prototype.clickAndStamp = function(startElement, endpointPosition, endpointElement, done) {
      ...
      return this.driver.moveTo(startElement, void 0, void 0).screenshot('clickAndStamp', "" + startElement + "-before-click").buttonDown(0).buttonUp(0).moveTo(endpointElement, 205, -5).moveTo(endpointElement, endpointPosition.x, endpointPosition.y).buttonDown(0).buttonUp(0).screenshot('clickAndStamp', "" + startElement + "-after-stamp").nodeify(done);
    };
